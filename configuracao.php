...
<td valign="top" align="center" style="color:#336600;font-size:10pt;background-color:#99cccc;padding:15px;height:20px;width:170px">
...
while($linha=mysql_fetch_array($sql))
		{
			   ...
			   $picture2='<img align="left" src="'.$foto.'" width="20%" height="">';
...
<td style="padding-left:70px;padding-top:30px;padding-right:70px;border:10px" width="800" valign="top" align="left" height="550" bgcolor="#ffffff">
...
<div align="center" style="background-color:#0000ff;;color:#ffffff;text-align:center;width:200px;padding:2px;">
...
echo '<span style="font-size:9pt;">Amigos de '.ucwords($_SESSION['nomeget']).'&nbsp;('.$rows.')<br>';
