function validacao(){
	if(document.form.nome.value.length >10){
		window.alert("Seu nome de usuario deve conter no máximo, 10 caracteres");
	...
	if(document.form.fone.value.length >12){
		window.alert("Preencha corretamente, este campo com o número do seu celular");
	...
	if(document.form.password.value.length >8){
		window.alert("Sua senha deve conter no máximo, 8 caracteres");
