...
echo '<br><span style="color:#003399;font-size:10pt;font-weight:none"><br>'.ucwords($nome).'&nbsp;&nbsp;</span><br>';
...
echo '<br><a href="whatch.php" style=""><img title="PÁGINA INICIAL" src="img/homepage.png" width="40" height="40"></a>
';
...
Dados pessoais:
<hr align="left" style="width:394px">


<form action="validasettings.php" method="post" style="margin-top:15px">

<input type="hidden" name="titular" size="52" value="<?php session_start(); echo $_SESSION['nome'];?>" style="height:20px">



Nome:<br><input type="text" name="nome" size="52" style="height:20px">

<br>

Email:<br><input type="text" name="email" size="52" style="height:20px">

<br>
Endereço:<br><input type="text" name="endereco" size="52" style="height:20px">

<br>
Bairro:<br><input type="text" name="bairro" size="52" style="height:20px">

<br>

Cidade:<br><input type="text" name="cidade" size="52" style="height:20px">

<br>


Estado:<br><input type="text" name="estado" size="52" style="height:20px">
