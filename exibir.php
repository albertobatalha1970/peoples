...
$rows=mysql_num_rows($sql)or die("Erro ao selecionar linhas");
if($rows>0)
{
...
<?php 
		 ...
		 echo '<div style="background-color:#65ca00;height:17px;width:380px;text-align:center"><span style="color:#ffffff;font-size:9pt">Nome do titular: '.$nome.'</span><br><br></div>';
		 echo '</table>';
		 echo '</span>';
...
autoposto samambaia - by Alberto Batalha
