...
if($rows<1)
	...
	{
	echo '<span style="color:#003399;font-size:12pt;font-weight:bold">'.ucwords($titular).'</span>&nbsp;ainda não adicionou dados pessoais ao seu perfil';
	}
	else
	{
while($exibe=mysql_fetch_array($sql))
{
	...
	echo '<span style="color:#003399;font-size:14pt;font-weight:none">Você está vendo o perfil pessoal de @'.ucwords($_SESSION['nomeget']).'</span>';
	...
	echo '<br><br>';
	echo '<span style="color:#003399;font-size:12pt;font-weight:none">Endereço: &nbsp;&nbsp;</span><br>'.$endereco;
	echo '<br><br>';
