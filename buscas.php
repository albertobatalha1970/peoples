...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    {
        echo "<span style=\"font-size:10pt\">Sua busca por&nbsp;<span style='color:#ff0000'>".$_POST['busca'].",</span> retornou <span style='color:#ff0000'>".$total."</span> ocorrência(s)<br><br></span><br>";
        $total = 0;
